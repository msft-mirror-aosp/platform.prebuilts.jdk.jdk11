...
DARWIN_AARCH64_ZIP=/tmp/$$.darwin_aarch64.zip
...
$FETCH_ARTIFACT --bid ${BUILD_NUMBER} --disable_progressbar --target darwin_mac_jetbrainsruntime jdk.zip ${DARWIN_AARCH64_ZIP}
...
rm -rf staging/darwin-aarch64
mkdir staging/darwin-aarch64
(cd staging/darwin-aarch64; unzip -q ${DARWIN_AARCH64_ZIP})
touch staging/darwin-x86/MODULE_LICENSE_GPL

rm -f ${LINUX_ZIP} ${DARWIN_ZIP} ${DARWIN_AARCH64_ZIP}
